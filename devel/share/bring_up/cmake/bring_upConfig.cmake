...
if("TRUE" STREQUAL "TRUE")
  set(bring_up_SOURCE_PREFIX /home/wukong/Hexapod-robot-with-Ros/src/bring_up)
  set(bring_up_DEVEL_PREFIX /home/wukong/Hexapod-robot-with-Ros/devel)
  set(bring_up_INSTALL_PREFIX "")
  set(bring_up_PREFIX ${bring_up_DEVEL_PREFIX})
else()
  set(bring_up_SOURCE_PREFIX "")
  set(bring_up_DEVEL_PREFIX "")
  set(bring_up_INSTALL_PREFIX /home/wukong/Hexapod-robot-with-Ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'wukong <wukong@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bring_up' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wukong/Hexapod-robot-with-Ros/src/bring_up/${idir}'.  ${_report}")
    endif()
